...
return [
    ...
    'order'=>[
        'status'=>[
            ...
            ['id'=>2, 'name'=>'待确认', 'forUser'=> false, 'forSeller'=>true, 'ico'=>'member01.png'],
            ['id'=>3, 'name'=>'待发货', 'forUser'=> false, 'forSeller'=>true, 'ico'=>'member02.png'],
            ['id'=>4, 'name'=>'待取货', 'forUser'=> true, 'forSeller'=>false, 'ico'=>'member02.png'],
            ['id'=>5, 'name'=>'已完成', 'forUser'=> true, 'forSeller'=>true, 'ico'=>'member03.png'],
            ['id'=>6, 'name'=>'已取消', 'forUser'=> true, 'forSeller'=>true, 'ico'=>'member04.png'],
